...
public final class ModSoundDefinitionsProvider extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        add(ModSoundEvents.TIANSULUO_PS_AMBIENT, definition().subtitle("subtitles.ohyeah.tiansuluo.ambient").with(
        ...
        add(ModSoundEvents.TIANSULUO_PS_RARE_CALL, definition().subtitle("subtitles.ohyeah.tiansuluo.rare_call").with(
        ...
        add(ModSoundEvents.TIANSULUO_PS_HURT, definition().subtitle("subtitles.ohyeah.tiansuluo.hurt").with(
        ...
        add(ModSoundEvents.TIANSULUO_PS_DEATH, definition().subtitle("subtitles.ohyeah.tiansuluo.death").with(sound("ohyeah:entity/tiansuluo_pink_scarf/death_01")));
        add(ModSoundEvents.TIANSULUO_PS_EAT, definition().subtitle("subtitles.ohyeah.tiansuluo.eat").with(sound("ohyeah:entity/tiansuluo_pink_scarf/eat_01")));
        add(ModSoundEvents.TIANSULUO_PS_EAT_FAVORITE, definition().subtitle("subtitles.ohyeah.tiansuluo.eat_favorite").with(sound("ohyeah:tiansuluo.eat_favorite", SoundDefinition.SoundType.EVENT)));
        add(ModSoundEvents.TIANSULUO_PS_TEMPTED, definition().subtitle("subtitles.ohyeah.tiansuluo.tempted").with(
        ...
        add(ModSoundEvents.TIANSULUO_PS_NOTICE_PLAYER, definition().subtitle("subtitles.ohyeah.tiansuluo.notice_player").with(sound("ohyeah:entity/tiansuluo_pink_scarf/notice_player_01"), sound("ohyeah:entity/tiansuluo_pink_scarf/notice_player_02")));
        add(ModSoundEvents.TIANSULUO_PS_SPAWN, definition().subtitle("subtitles.ohyeah.tiansuluo.spawn").with(sound("ohyeah:entity/tiansuluo_pink_scarf/notice_player_01")));
        add(ModSoundEvents.TIANSULUO_PS_BREED_SUCCESS, definition().subtitle("subtitles.ohyeah.tiansuluo.breed_success").with(sound("ohyeah:entity/tiansuluo_pink_scarf/breed_success_01")));
        add(ModSoundEvents.TIANSULUO_PS_CARRY_EGG, definition().subtitle("subtitles.ohyeah.tiansuluo.carry_egg").with(sound("ohyeah:tiansuluo.carry_egg", SoundDefinition.SoundType.EVENT)));
        add(ModSoundEvents.TIANSULUO_PS_ATTACK_SHOT, definition().subtitle("subtitles.ohyeah.tiansuluo.attack_shot").with(sound("ohyeah:tiansuluo.attack_shot", SoundDefinition.SoundType.EVENT)));
        add(ModSoundEvents.TIANSULUO_PS_ATTACK_END, definition().subtitle("subtitles.ohyeah.tiansuluo.attack_end").with(sound("ohyeah:tiansuluo.attack_end", SoundDefinition.SoundType.EVENT)));
        add(ModSoundEvents.TIANSULUO_PS_ATTACK_DECLARE, definition().subtitle("subtitles.ohyeah.tiansuluo.attack_declare").with(sound("ohyeah:tiansuluo.attack_declare", SoundDefinition.SoundType.EVENT)));
        add(ModSoundEvents.TIANSULUO_PS_GROW_UP, definition().subtitle("subtitles.ohyeah.tiansuluo.grow_up").with(sound("ohyeah:entity/tiansuluo_pink_scarf/grow_up_01")));
        add(ModSoundEvents.TIANSULUO_PS_SHEAR_REACT, definition().subtitle("subtitles.ohyeah.tiansuluo.shear_react").with(sound("ohyeah:tiansuluo.shear_react", SoundDefinition.SoundType.EVENT)));
